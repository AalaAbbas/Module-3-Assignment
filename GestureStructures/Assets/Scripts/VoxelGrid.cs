...
public class VoxelGrid
{
    ...
    public VoxelGrid(Vector3Int size, Vector3 origin, float voxelSize, Transform parent = null, bool bottomOnly = true)
    {
        GridSize = size;
        Origin = origin;
        VoxelSize = voxelSize;
    ...
    public bool CreateBlackRectangle(Vector3Int origin, int width, int depth, int layer = 0, bool picky = true)
    {
        ...
        for (int i = 0; i < radius; i++)
        {
            ...
            foreach (var voxel in blobVoxels)
            {
                ...
                foreach (var neighbour in neighbours)
                {
                    ...
                    bool takeMe = true;
                    if (picky && (Random.value < 0.6f)) takeMe = false;
